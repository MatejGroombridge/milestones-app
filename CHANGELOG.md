# Changelog
All notable changes to Milestones. Format roughly follows
...
<!-- `bin/changeset` inserts new entries at the first blank line after the H1,
     ...
     that release.yml extracts and publishes to the manifest. -->

## v0.1.0 — 2026-08-09

Initial release — track personal bests and beat them
